...
On the other hand, $f=f^\o|\spc{L}$, hence $\dd_p f=\dd_p f^\o|\T_p \spc{L}$.
...
This observation was was used by the third author to prove Alexandrov spaces with nonnegative curvature have nonnegative Ricci curvature in the sense of Lott--Villani--Sturm \cite{petrunin:optimal}.
