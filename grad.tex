...
Then $\sigma$ is 1-Lipschitz;
in particular, for any $s\in [s_{\min},s_{\max})$, 
...
Then the radial monotonicity implies that $\psi$ is nonincreasing function defined in $[s_{\min},\tfrac{\varpi\kappa}2)$.
