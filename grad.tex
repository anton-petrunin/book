...
\begin{thm}{Example}
Let $\spc{X}=\R^2$ and $f(v)=-|v|_\infty$. Then $f$ is concave. Recall  that at points $(x,y)\ne 0$ with $|x|\ne |y|$ the gradient has length 1 and is parallel to either the $x$ or the $y$ axis  at nonzero points with $|x|=|y|$ the gradient is equal to $(\pm \frac{1}{2},\pm\frac{1}{2})$.
...
Examples of such functions include the entropy and some other closely related functionals on the Wasserstein space over a $\Alex0$ space.
