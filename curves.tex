...
Let $\spc{L}\in\CBB{m}{}$ and $\spc{N}$ be either $\cCat{}{}$ or $\Alex{}$ space.
...
\begin{thm}{Exercise}
Construct a infinite-dimesnional complete length $\Alex{\kappa}$ space $\spc{L}\in\CBB\infty{}$ and a curve $\alpha\:\RR\to \spc{L}$ such that 
$\alpha^+(0)=o$ 
