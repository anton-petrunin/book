...
Let $[\tilde x\tilde z\tilde p]=\modtrig\kappa xzp$.
Extend the side $[\tilde x\tilde z]$ 
behind $\tilde z$, let $\tilde y$ 
be the point on the extension such that $\dist{\tilde x}{\tilde y}{\Lob2\kappa}=\dist{x}{y}{\spc{W}}$.
If $\alpha<\mangle\hinge {\tilde z}{\tilde y}{\tilde p}$,
choose a point $\tilde w\in [\tilde y\tilde p]$ such that $\alpha=\mangle\hinge {\tilde z}{\tilde y}{\tilde w}$,
otherwise set $\tilde w=\tilde p$.

Let $\beta_n$ be the $\kappa$-radial curve with respect to $z$ starting at $b_n$.
Set $c_n=\beta_n(\dist{\tilde z}{\tilde w}{})$.
By Radial monotonicity~\ref{rad-mon}, we get
\begin{align*}
\dist{p}{y}{\spc{W}}
&\le\lim_{n\to\o}\dist{y}{c_n}{\spc{L}}+\dist{p}{c_n}{\spc{L}}\le
\\
&\le \dist{\tilde y}{\tilde p}{\Lob2\kappa}
\end{align*}
...
$\proj\:\tilde U\to U$ be a covering map which is branching along a simple curve $\gamma$.
Define the length-metric on $\tilde U$ by setting 
\[\length\alpha=\length(\proj\circ\alpha).\]
Prove that $\tilde U$ is $\CAT0$ if and only if $\gamma$ is a line.
\end{thm}
