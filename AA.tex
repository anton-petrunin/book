...
The proof of these two statements are almost the same as the proofs of \ref{rad-mon} and \ref{rad-comp}.
...
Let $[pq]$ be an $A$-radial geodesic.
Then
...
\[\dist{\gexp\mc\kappa_A v}{\gexp\mc\kappa_A w}{}
\le
\side\kappa\hinge{\0}v w.\]
In other words, if we denote by $\mathcal{T}_{p}\mc\kappa$ the set $\cBall[\0,\tfrac{\varpi\kappa}2]_{\T_p}$ 
equipped with the metric $\dist{v}{w}{\mathcal{T}\mc\kappa_{A}}=\side\kappa\hinge{\0}v w$, 
then 
\[\gexp\mc\kappa_A:\mathcal{T}\mc\kappa_{A}\to \spc{L}\] 
is a short map.
\end{subthm}
...
\[\sigma(t)=\gexp\mc\kappa_A(t\cdot v),\]
then the function
\[
s\mapsto 
\tangle\mc\kappa\{\dist{q}{\sigma(s)}{};\distfun A{q}{},s\}
\]
is nonincreasing in its domain of definition.
\end{subthm}
\end{thm}
