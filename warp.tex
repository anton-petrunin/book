...
$\beta\:[0,1]\to \spc{B}\times\spc{F}$ with the same end points such that 
...
The $1$-cone $\Cone\mc1\spc{F}$ is also called the \index{spherical suspension}\emph{spherical suspension} over $\spc{F}$, and is also denoted by $\Susp\spc{F}$.
That is,
\[
