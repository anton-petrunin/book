...
\parbf{Example.} 
Mere continuity of $f$ does not suffice for the warped product construction, even if $f>0$. 
For example, let $\spc{B}$ be the union of intervals $B^i=[0,1/i]$ glued at $0$, $f(0)=1$, $(f|B_i)(1/i)=1/i$, 
$\spc{F}=[0,1]$.  
For $\gamma(t)=(0,t)$, $0\le t \e 1$, we have $L=1$, while the infimum of lengths of admissible curves joining any two points of $\gamma$ is $0$.
...
\[(p,s),(x^1,t^1),(x^2,t^2),(x^3,t^3)\in \spc{L}\warp{\sinh}[0,\infty).\]
...
\[\Cone\mc{-1}\SS^2=\SS^2\warp{\sinh}[0,\infty)\iso\Lob{3}{-1}.\]

Consider the quadruple points 
\[(q,s),(y^1,t^1),(y^2,t^2),(y^3,t^3)\in \SS^2\warp{\sinh}[0,\infty)\iso\Lob{3}{-1}.\]
