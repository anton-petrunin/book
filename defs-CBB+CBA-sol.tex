...
it includes compact length, locally $\CAT0$ spaces. 
...
In the $\CAT1$ case we have a geodesic circle of length $<2\cdot \pi$.
...
One also need to apply \ref{thm:hadamard-cartan-gen}, to show that curves $\gamma_1$ and $\gamma_2$ are not contractible in the class of curves shorter than $2\cdot \pi$.
