...
\parbf{Exercise~\ref{ex:nonconvex-limit}.} Let $\spc{X}_n$ be the plane with the metric induced by $\ell^n$-norm and let $f_n(x,y)=x$ for all $n$.
...
\parbf{Exercise~\ref{ex:Hadamard--Cartan}.} Mimic the proof of Hadamard--Cartan theorem.
