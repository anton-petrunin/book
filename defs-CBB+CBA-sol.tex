...
Modify the induced length metric on the unit sphere in an infinite dimensional  Hilbert space in small neighborhoods of a countable collection of points. To prove that the obtained space is $\Alex0$, you may need to use the technique from Halbeisen's example (\ref{Halbeisen's example}).
