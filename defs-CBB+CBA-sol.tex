...
Observe that $\spc{X}_\o$ is the plane with the metric induced by the $\ell^\infty$-norm where the limit function $f_\o(x,y)=x$ is not concave.
...
Modify the induced length metric on the unit sphere in a Hilbert space in small neighborhoods of a countable collection of points.
