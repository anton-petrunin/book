...
The following corollary states that the gradient vector field is monotonic in the sense similar to the definition of \index{monotone operator}\emph{monotone operators}; see for example \cite{phelps}.
