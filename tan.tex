...
At the end of this section we give an extension of Rademacher theorem for $\Alex{}$ and $\CAT{}$ spaces (\ref{thm:Rademacher-CBB+CBA}) proved by Alexander Lytchak \cite{lytchak:diff}. 
...
Note that once it is proved, Lemma \ref{lem:CBB-diff-curve} implies the proposition in the $\Alex{}$ case.
