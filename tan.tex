...
the  $\Alex{}$ and $\CAT{}$ spaces have \index{space with defined angles}\emph{defined angles};
...
If $\spc{U}$ is a complete length $\CAT\kappa$ space and $p\in \spc{U}$ then $\T^\o_p$ is a complete length $\CAT0$ space.
\end{subthm}
...
Since $n\cdot(\spc{U},p)\to(\T_p^\o,\0)$ as $n\to\o$, Proposition~\ref{prop:CAT^omega} implies that ${\T^\o_p}$ is a complete length $\CAT0$ space.
\qeds
