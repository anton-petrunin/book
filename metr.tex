...
\\
\cBall[x,R]&=\set{y\in \spc{X}}{ \dist{x}{y}{}\le R}%V: I suggest using just square brackets or just a bar over B for closed balls. Using both is an overkill. %S. I prefer B(A,R) and \bar B(A,R) where A is radius, B and \bar B tell open or closed.  This is easiest and makes most sense.
\end{align*}
