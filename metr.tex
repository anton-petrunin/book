...
If for the projections $\spc{X}\to(\spc{X}/{\sim},\rho_\alpha)$ are \index{short map}\emph{short} (that is, \textit{distance non-increasing}), then the same is true for $\spc{X}\to(\spc{X}/{\sim},\rho)$.
