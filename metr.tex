...
\end{matrix}
\]
The resulting $\infty$-metric space $\bm{X}$ will be called the \emph{disjoint union}\index{disjoint union of metric spaces} of $\{\spc{X}_\alpha\}_{\alpha\in\IndexSet}$ and  denoted by \[\bigsqcup_{\alpha\in\IndexSet}\spc{X}_\alpha.\]
\end{thm}
