...
\end{align*}
are called respectively the  \index{open $R$-neighborhood}\emph{open} and \index{closed $R$-neighborhood}\emph{closed $R$-neighborhoods} of $A$.
...
if for any two points $x,y$ with $\dist{x}{y}{}<\infty$ there is a geodesic $[x y]$ in $\spc X$
