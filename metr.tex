...
If for these two pseudometrics $\rho_1$ and $\rho_2$ the projections $\spc{X}\to(\spc{X}/{\sim},\rho_i)$ are \emph{short} (i.e.  distance non-increasing), then the same is true for $\rho(x,y)$.
