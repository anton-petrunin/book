...
(see Section ??).
%%??? V:  what reference is this meant to be? I don't see any need for a reference here. packing numbers have been previously defined.
\end{thm}
...
%, where ??.
%S. need to define \bar r, ??? V: I changed $\bar r$ to $\bar R$.
