...
Assume there is a distance preserving cone embedding $\iota\:\EE^{m}\hookrightarrow \T_p\spc{L}$.
Then either
\begin{subthm}{}
...
The proof is essentially done in \ref{E=T}, \ref{pack-homogeneus}, \ref{E-comeagre}, \ref{thm:inverse-function},
...
The value $R$ depend only on the following numbers:  
...
is called a \index{distant chart}\emph{distant chart},
the restrictions $x^i=\distfun{a^i}{}{}|_{\oBall(p,R)}$ are called \index{coordinate of the distant chart}\emph{coordinates}
and the restriction $y=\distfun{b}{}{}|_{\oBall(p,R)}$ is called \index{strut of the distant chart}\emph{strut} of the distant chart.
\end{thm}
