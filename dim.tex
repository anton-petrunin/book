...
\[\kappa,\  \dist{p}{a^i}{},\ \dist{a^i}{a^j}{},\ \dist{b}{a^i}{}\]
for all $i$ and $j$.
\end{subthm}
...
the restrictions $x^i=\distfun{a^i}{}{}|_{\oBall(p,R)}$ are called \emph{coordinates}\index{coordinate of the distant chart}
and the restriction $y=\distfun{b}{}{}|_{\oBall(p,R)}$ is called \emph{strut}\index{strut of the distant chart} of the distant chart.
\end{thm}
