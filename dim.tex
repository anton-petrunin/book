...
The cosine law gives a constant $\delta=\delta(\kappa,R,\bar R,\dist{p}{\bar p}{})>0$ such that 
...
The next theorem is a refinement of Theorem \ref{thm:dim-infty} for the finite-dimensional case.
...
The above theorem was essentially proved by Yuriy Burago, Grigori Perelman, and Michael Gromov \cite{burago-gromov-perelman}.
