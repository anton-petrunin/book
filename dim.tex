...
\parbf{On product spaces.} Let us mention that
\begin{align*}
...
\begin{lpic}[t(0mm),b(0mm),r(0mm),l(0mm)]{pics/dim=1(1)}
\lbl[t]{2,.5;$x$}
\lbl[t]{9,.5;$p$}
\lbl[t]{14,.5;$q$}
\lbl[t]{27,.5;$y$}
...
appers in \cite{kleiner} (see also \cite[p.~133]{gromov:asymt-inv}) %???CHECK
 remains open for nonseparable $\CAT{}$ spaces;
for separable spaces it is true by Corollary~\ref{cor:dim-CBA}.

\begin{thm}{Conjecture}
If $\spc{U}$ is a complete length $\CAT{}$ space, then 
\[\TopDim\spc{U}
=
\LinDim\spc{U}.\]
