...
we denote by $\bm{a}^{\without 0}$ the subarray of $\bm{a}$ with $a^0$ removed;
that is,
\[\bm{a}^{\without 0}=(a^1,a^2,\dots,a^\kay).\]
...
the restrictions $x^i=\distfun{a^i}{}{}|\oBall(p,R)$ are called \emph{coordinates}\index{coordinate of the distant chart}
and the restriction $y=\distfun{a^0}{}{}|\oBall(p,R)$ is called \emph{strut}\index{strut of the distant chart} of the distant chart.
\end{thm}
