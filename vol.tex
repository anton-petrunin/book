...
for any any Borel set $A\subset \Dom \iota$.
...
\Const\cdot\SphMes_m A
\eqlbl{eq:=SphMes}\]
for any any Borel set $A\subset W$.
...
Further, if $\spc{L}\in \CBB{m}{}$ we will say \emph{almost everywhere}\index{almost everywhere} meaning $\vol_m$-almost everywhere. 
\end{thm}
