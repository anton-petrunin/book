...
%Instead of defining $\Cat{}{\kappa}$ in terms of (2+2)-point $\kappa$-comparison, as in definition \ref{def:cat}, the following theorem shows  we could  have used dual-$\Alex\kappa$ comparison instead.  
