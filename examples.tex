...
In the proof we apply the following lemma from \ref{edwards}; 
...
It remains to note that $\mathfrak{C}$ can be presented as intersection of open two-convex sets 
\[\Omega_n=\set{(x,y,z)\in \EE^3}{z\lg f(x,y)\pm\tfrac1n,\ (x,y)\in U}\]
for $n=\{1,2,\dots\}$.
\qeds
