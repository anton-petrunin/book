...
but in general we only have locally distance preserving map $\hat\Omega\toK$ which is onto but in general may be not injective. Say consider a polytope with a 
