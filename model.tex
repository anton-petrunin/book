...
$\sn{}$ stands for sine; $\cs{}$,  for cosine; and $\md{}$, for modified distance. They are defined as follows:
  Let $\sn\kappa$, $\cs\kappa$, $\overline {\md\kappa}\co \RR_{\ge}\to\RR$  be   the solutions of the following IVPs respectively
...
\md\kappa(t)=
\begin{cases} 
\overline {\md\kappa} \textrm{ if } 0\le t\le \varpi\kappa \\
\frac{2}{k} \textrm{ if  } t> \varpi\kappa
\end{cases}
\]
