...
Note that
%\[\md\kappa(0)=(\md\kappa)'(0)=0\quad \text{and}\quad 
%(\md\kappa)''(x)=1-\kappa\cdot\md\kappa(x)\quad \text{for}\quad x<\varpi\kappa.\]
%Also,
\[
\mdk(x)=\int\limits_0^x
\snk(x)\cdot\dd x \ \text{ for }\quad x\le \varpi\kappa
\]
