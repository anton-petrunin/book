...
The  model $\kappa$-plane  will be denoted by $\Lob2\kappa$\index{$\Lob2\kappa$}.
\begin{itemize}
...
The distance between points $x,y\in \Lob2\kappa$ will be denoted by $\dist{x}{y}{}$\index{$\dist{p}{q}{}$}, and $[x y]$\index{$[{p}{q}]$} 
...
A triangle in $\Lob2\kappa$ with vertices $x,y,z$ will be denoted by $\trig x y z$\index{$\trig{{p}}{{q}}{{r}}$}.
...
By $\modtrig\kappa\{a,b,c\}$\index{$\modtrig\kappa$!$\modtrig\kappa\{{a},{b},{c}\}$} we denote a triangle in 
...
opposite to $a$.
In this case, we will write \label{page:model-side}\index{$\side\kappa$!$\side\kappa \{{a};{b},{c}\}$}
\[a
=
\side\kappa\{\phi;b,c\}
\quad  \text{or}\quad 
