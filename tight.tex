...
Moreover $\d_p\bm{x}\:\T_p\to\RR^m$ is $[\eps,m]$-bi-Lipshitz %\sqrt{m} works as well???
...
\ell^2.
\end{align*}
That is, \ref{eq:f_is_concave} holds for $\Lambda=\lambda\cdot\l(\tfrac{\sqrt{m}}{\eps^3}+\tfrac1{\eps^2}\r)$.
\qeds
...
such that the distance map $\distfun{\bm{a}}{}{}\:\spc{L}\to\RR^\kay$ is an embedding $\oBall(z,R)\hookrightarrow\RR^\kay$, 
