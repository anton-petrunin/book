...
To define $s(t,\tau)$, consider three rays $\tilde \gamma^1$, $\tilde \gamma^2$, $\tilde \gamma^3$ on a Euclidean plane starting at one point, such that $\mangle(\tilde \gamma^1,\tilde \gamma^2)=\alpha^{12}+\eps$, $\mangle(\tilde \gamma^2,\tilde \gamma^3)=\alpha^{23}+\eps$ and $\mangle(\tilde \gamma^1,\tilde \gamma^3)=\alpha^{12}+\alpha^{23}+2\cdot \eps$.
...
Suppose that $\speed_t\alpha$, $\alpha^+(t)$ and $\alpha^-(t)$ are defined, show that $\alpha$ is differentiable at $t$.
\end{thm}
