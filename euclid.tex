...
We use our definition of angle since in Alexandrov's geometry angles always defined (see Theorem~\ref{angle} and Corollary~\ref{cor:monoton-cba:angle=inf}).
...
The triangle inequality (\ref{claim:angle-3angle-inq}) holds upper angles as well.