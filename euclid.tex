...
We say that $v\in\T_p$ is the \emph{right derivative}\index{right derivative} of $\alpha$ at $0$,
briefly $\alpha^+(0)\z=v$\index{$\alpha^+(0)$}, if for some (and therefore any) sequence of vectors $v_n\in\T'_p$ such that $v_n\to v$ as $n\to\infty$,
