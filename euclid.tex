...
we say respectively that $\alpha$ is \index{differentiable curve!left/right differentiable}\emph{right} or \emph{left} or \emph{both-sided differentiable} at $t_0$.
