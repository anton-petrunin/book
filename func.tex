...
Convexity is used mainly in CBA, Concavity is used mainly in CBB.%V: That's a strange statement IMO. what's used is concavity (respectively convexity) of distance functions.
...
Let us equip it with Hausdorff convergence,
...
The following generalization of Rademacher's theorem was proved by Bernd Kirchheim \cite{kirchheim}. %CHECK??? %S: No need to  check.
