...
\begin{itemize}
 \item The $1$-Lipschitz maps will be also called \index{short map}\emph{short}.
\end{itemize}
...
the curve it called \index{Lipschitz curve}\emph{Lipschitz} or \index{locally Lipschitz curve}\emph{locally Lipschitz} if the map $\alpha\:\II\to \spc{X}$~is.
...
A curve $\alpha\:\II\to\spc{X}$ is called \index{unit-speed curve}\emph{unit-speed curve}, 
...
will be called \index{differential of metric}\emph{differential of induced metric} at $x$.
...
The function $\bar y$ is called {}\emph{lower} (respectively {}\emph{upper}) \index{barrier}\emph{barrier} of $y$ at $t_0$.
\end{subthm}
