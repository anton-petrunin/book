...
Note that Theorem ~\ref{y''=<1-ky} implies that $y$ satisfies $y''\ge \lambda$ ($y''\le \lambda$)  on an interval $\II\subset\RR$  if and only if $y(t)-\frac{\lambda}{2}\cdot t^2$ is convex (concave) on $\II$.
