...
A curve is called \index{Lipschitz map!Lipschitz curve}\emph{Lipschitz} or \index{locally Lipschitz curve}\emph{locally Lipschitz} if $\alpha$ is Lipschitz or locally Lipschitz. 
...
will be called its \index{differential of metric}\emph{differential of the induced metric} at $x$, or \index{metric differential}\emph{metric differential} at $x$.
