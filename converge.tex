...
however this refinement was a step back to so called \emph{closed convergence} introduced by Hausdorff in in the original book. 
...
Assume that for for some (and therefore any) point  $x\in\spc{X}$ 
...
\parit{Proof.}
Note that that there is a sequence of integers $M_1<M_2<\dots$
