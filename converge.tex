...
and a point $p_\infty\in\spc{X}_\infty$ any sequence of points $p_n\in\spc{X}_n$ such that $p_n\GHto p$  will be called \index{lifting of a point}\emph{lifting} of $p_\infty$.
...
is called \index{isometry!$\eps$-siometry}\emph{$\eps$-isometry}
