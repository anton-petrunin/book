...
denote by $\iota_n\#\mu_n$ the pushforward measures on $\bm{X}$.%V: I would suggest using the notation ${\iota_n}_\#\mu_n$ , i.e. making $\#$  a subindex. That's a much more standard notation for pushforward. 
