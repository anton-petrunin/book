...
Let $\spc{X}_1,\spc{X}_2,\dots$ and $\spc{X}_\infty$ be metric spaces.
Suppose that either 

\begin{subthm}{}
for each $n$ there is an $\eps_n$-isometry $f_n\:\spc{X}_n\to\spc{X}_\infty$ and $\eps_n\to\0+$ as $n\to\infty$.
\end{subthm}

\begin{subthm}{}
for each $n$ there is an $\eps_n$-isometry $h_n\:\spc{X}_\infty\to\spc{X}_n$ and $\eps_n\to\0+$ as $n\to\infty$.
\end{subthm}
...
Choose a nonprinciple ultrafilter $\o$.
