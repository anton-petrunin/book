...
Let us list the most important sources of examples of $\Alex{}$ spaces.
It should be beneficial to the reader despite we do not provide all proofs on the spot.
...
Most of applications in Riemannian geometry are based on the described sources and the following corollary of Gromov's selection theorem (\ref{thm:gromov-selection}) and the Bishop--Gromov inequality.
