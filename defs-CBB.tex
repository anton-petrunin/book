...
=\pi.\]
By \ref{eq:thm:devel*}, 
the simple  \emph{closed}  broken polygonal line $\tilde x_0\tilde x_1\dots\tilde x_\kay\tilde y\tilde x_0$ bounds a region  $A\subset \SS^2$ which 
 is locally convex. Therefore $A$ is convex because a subset of $\SS^2$ is convex iff it is locally convex.
