...
The right hand side in \ref{eq:1st-var+***} is called \index{angle!strong angle}\index{strong angle}\emph{strong angle} of hinge $\hinge p q x$. 
...
The value $\angk{\kappa+} p q r$ is called \index{angle!extended model angle}\index{model angle!extended model angle}\index{extended model angle}\emph{extended model angle} of triple $p$, $q$, $r$.
\end{thm}
