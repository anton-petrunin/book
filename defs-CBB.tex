...
in a $\Alex{\kappa}$ space is $\kappa$-thick.
...
%??? V: I really hate the variable $\dd\under{t}$. Can we please change not use it? Not just here but anywhere. Unnecessarily weird notations like this one just make the book harder to read??? A: If we do not use it, then we need to introduce an extra variable every time we take integral --- do we really want it --- we use it 10 times or so???
\end{align*}
