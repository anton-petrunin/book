...
Since $\gamma$ does not pass thru $p'$, the development comparison implies that the polygonal line $\tilde x_0\dots\tilde x_n$ does not pass thru $\tilde p'$.
...
Since $\gamma\in B_\pi(p')$, the point-on-side comparison implies that the polygonal line $\tilde x_0\dots\tilde x_n$ can not pass thru the antipodal point of $\tilde p'$.
...
since the polygonal line $\tilde x_0\dots\tilde x_n$ does not pass thru $\tilde p'$ this implies that $\theta=0$.
