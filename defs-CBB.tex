...
then the limit of rescaled copies $\tfrac1n\cdot M$ as $n\to \infty$ is $\Alex0$; this is the so-called \textit{asymptotic cone} of $M$.

Most applications are based on the described sources and the \textit{Gromov compactness theorem}.
The latter provides a converging subsequence in the sense of Gromov--Hausdorff in a sequence of Riemannian manifold with curvature and dimension bounds.
...
Among less important examples, let us mention \emph{polyhedral spaces},
