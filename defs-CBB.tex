...
\begin{thm}{Example}
A Riemannian manifold $(M^n,g)$ with induced metric is locally $\Alex{\kappa}$ iff sectional curvature of $M$ is bounded below by $\kappa$. This is an easy consequence of  Rauch comparison.
A complete Riemannian manifold of sectional curvature bounded below by $\kappa$ is globally $\Alex{\kappa}$. This was originally proved by Toponogov and will follow in more generality from the globalization theorem  below \eqref{thm:glob}.
...
\begin{thm}{Example}
Let $G\subset O(n+1)$ be a closed subgroup, then $\SS^n/G$ is $\Alex{1}$
and  $\R^{n+1}/G$ is $\Alex{0}$.
\end{thm}
