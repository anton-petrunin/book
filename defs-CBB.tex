...
($p^*$ such that  $s_0\le r^*\z<\min\{\varpi\kappa,\tfrac32\cdot s_0\}$ will do).
...
This definition is good for $\Alex{}$ spaces, but for $\CAT{}$ spaces there is a similar definition.
Some authors define comparison angle to be $\angk{\kappa+}{{*}}{{*}}{{*}}$.
