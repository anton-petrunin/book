...
they give conditions that guarantee that gluing of two (or more) spaces is $\Alex{\kappa}$.Further, \textit{Wasserstein space} of order $2$ over $\Alex0$ space is $\Alex0$.
There is a natural metric on the space of all metric-measure spaces that makes it $\Alex0$ space;
