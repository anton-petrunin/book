...
Since all the model triangles are defined this polygonal line $\tilde x_0\dots\tilde x_n$ can not pass thru the antipodal point of $\tilde p'$.

Consider the space $L$ glued from the \emph{solid} model triangles $\trig{\tilde p'}{\tilde x_{0}}{\tilde x_1},\dots,\trig{\tilde p'}{\tilde x_{n-1}}{\tilde x_n}$ along the corresponding sides.
