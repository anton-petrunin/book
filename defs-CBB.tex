...
\subsection*{Sources of examples}
...
Also, there is quite general sufficient conditions that guarantee that gluing of two spaces is $\Alex{\kappa}$;
it was given by Nikolai Kosovsky \cite{Kosovski}.
