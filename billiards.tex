...
Any Reshetnyak's puff pastry is a locally compact geodesic $\CAT0$ space.
\end{thm}
...
$\spc{R}$ and  $\check{\spc{R}}$ are a complete length $\CAT0$ space , 
...
Since $\spc{R}_\gamma$ is a complete length $\CAT0$ space (see Observation~\ref{obs:puff pastry is CAT}),
$\bar\gamma$ is a geodesic.

Since $\gamma$ does not intersect $A_1\cap\dots\cap A_n$,
