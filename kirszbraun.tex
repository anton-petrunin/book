...
In particular, this inequality in general metric spaces (not necessarily length space) does not imply the inequality in the following exercise.
...
and the paper of Nina Lebedeva, Vladimir Zolotov and the third author~\cite{lebedeva-petrunin-zolotov}.
...
The following exercise gives an analog of the finite$\bm{+}$one lemma (\ref{lem:kirsz-neg:new}),  discovered by the third author and Stephan Stadler \cite{perunin-stadler}.
