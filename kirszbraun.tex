...
We say that a space $\spc{X}$ is an \emph{injective metric space}\index{injective} 
...
Prove that any metric space $\spc X$ can be isometrically embedded into an injective metric space.
\end{subthm}
