...
\begin{thm}{Exercise}
Let $p,x_1,\dots,x_n$ be a point array $p,x_1,\dots,x_n$ in a $\Alex0$ space.
...
In this section we present a collection of exercises on a curvature-free versions of Kirszbraun theorem.
...
see our paper \cite{akp-kirszbraun} for more on this 
and the paper of Nina Lebedeva, Vladimir Zolotov and the second author \cite{LPZ} for more recent development.
