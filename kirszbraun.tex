...
\lbl[lt]{12,15.5;{\small $\~p^1$}}
\lbl[bl]{5.5,18;{\small $\~p^2$}}
\lbl[r]{5,6.5;{\small $\~p^3$}}
\lbl[lb]{4,25;$\~x^1$}
\lbl[t]{2,0;$\~x^2$}
\lbl[l]{18,16;$\~x^3$}
\end{lpic}
...
\lbl[br]{13.5,7;{\small $\~p^3$}}
\lbl[t]{17,12.5;{\small $\~p^1$}}
\lbl[bl]{8,14;{\small $\~p^2$}}
\lbl[t]{1,0;$\~x^1$}
\lbl[t]{29,0;$\~x^2$}
