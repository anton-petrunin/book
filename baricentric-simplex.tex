...
\parit(\ref{SHORT.thm:web:Up-convex})+(\ref{SHORT.thm:web:f(web)=min}).}
%*S: I did not know how to typeset this correctly
...
>>>>>>> 5864da762246beb032a3a5b43a2190c044c2eaff
...
By the Tietze extension theorem%ref???
...
the image $F_\eps\circ\map[2]\circ\map(K)$ lies in the $F_\eps$-image of $(m-1)$-skeleton of $\spc{N}'$;
