...
Note that $\dist{\partial\spc{L}}{}{}$ (as well as function $f$ defined in the theorem) is not native semiconcave function of $\spc{L}$ (see definition ???). 

\begin{wrapfigure}{r}{40mm}
\begin{lpic}[t(0mm),b(10mm),r(0mm),l(0mm)]{pics/dist-to-bry(0.4)}
\lbl[b]{14,144;$\~\gamma(0)$}
\lbl[b]{63,158;$\~\gamma(\tau)$}
\lbl[lt]{22,134;$\alpha$}
\lbl[b]{18,39;$\~\beta$}
\lbl[t]{15,15;$\~ p$}
\lbl[t]{63,15;$\~ q$}
...
we will denote by $\Fr A=\Fr_\spc{X} A$\index{$\Fr$} the \emph{frontier}\index{frontier} (relative boundary) of $A$ in $\spc{X}$ 
