...
$\CAT{\kappa}$ 
if any quadruple $p,x^1,x^2,x^3\in \spc{U}$ satisfies  $\CAT{\kappa}$ comparison.
\end{subthm}
...
\parit{Proof.} 
By angle-sidelength  monotonicity  (\ref{cor:monoton-cba}), the righthand side is defined and bigger than or  equal to the lefthand side. 
