...
In other words the Definition~\ref{def:cat} is more general than Definition~\ref{def:ccat}.
...
if and only if there is a space $\bar{\spc{U}}\in \cCat{}{\kappa}$ which contains a $\varpi\kappa$-convex set isometric to $\spc{U}$.
\end{thm}
...
contains the original space $\spc{U}$ as a $\varpi\kappa$-convex subset.
\qeds
