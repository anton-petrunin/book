...
\parit{Proof.}
Apply Corollary \ref{cor:geo-hom}, setting $\alpha^0(t)=\alpha(0)$ for all $t\in [0,1],$ and $\alpha^1=\alpha$. By \ref{cor:geo-hom-length}  there is an interval $\II$ such that (a) holds for all $t\in\II$, and either $\II=[0,1]$ or $\II=[0,a)$ for some $a\le 1$.
...
Since $\ell<\varpi\kappa$, \ref{cor:geo-hom} implies that neither of these is possible.
\qeds
