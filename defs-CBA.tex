...
Finally consider the case $\kappa>0$; by  scaling, take $\kappa=1$.
 Then by Theorem \ref{}, $\Cone\spc{U}_i$ is a $\CAT0$ space for $i=1.2$. Geodesics of $\Cone\spc{U}_i$ that do not pass through the vertex of the cone are carried by projection from the vertex to pregeodesics of $\spc{U}_i$ of length $<\pi$, by \ref{}. 
  It follows that $\Cone A$ is $\pi$-convex in $\Cone\spc{U}_1$ and $\Cone\spc{U}_2$. $\Cone A$ is complete since $A$ is complete $\ldots$.
