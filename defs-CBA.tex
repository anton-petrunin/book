...
Useful definitions in terms of convexity of distance functions and developments are formulated in Section~\ref{sec:func-comp}.
...
We write $\spc{U}\in\CBA{}{}$ to mean: $\spc{U}$ has curvature $\le\kappa$ for some $\kappa$.  
We also refer to $\spc{U}$ as a $\CBA{}{}$ space.   
\end{thm}
...
$\cBall[p,\varpi\kappa/2]$ is the Hausdorff limit of $\cBall[p,R]$ for $R\to(\tfrac{\varpi\kappa}2)-$.
...
By Corollary~\ref{thm:convex-balls}, the ball
...
Let $\spc{U}\in\cCat{}{0}$.
Assume that for 4 points $x_1,x_2,x_3,x_4\in \spc{U}$
there is a convex quadrilateral
$\~x_1\~x_2\~x_3\~x_4$
in the Euclidean plane $\EE^2$
such that 
