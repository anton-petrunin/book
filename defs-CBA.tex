...
a geodesic $\hat\alpha\:[a,b]\to\hat\Omega$,
and an open locally distance-preserving immersion 
%V: what exactly does this phrase mean? it's never defined and the word immersion is not used anywhere else in the book.
...
for all $i>0$ and  $\spc{B}_i\cap \spc{B}_{i+2}\subset \spc{B}_{i+1}$ for all $i\le n-2$.
%V: I think the last condition needs to be added to make sure that the new space is locally isometric to the old one.
