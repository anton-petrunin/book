...
Geodesics of $\Cone\spc{U}^i$ that do not pass thru the tip of the cone  project to geodesics of length $<\pi$ in $\spc{U}^i$. 
...
In particular, for all sufficiently large $n$, any subsegment of $\gamma_n$ thru $\gamma_n(t)$  with length less than $R/2$ is a geodesic.
