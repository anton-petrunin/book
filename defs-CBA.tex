...
The question of when \textit{Riemannian manifolds with boundary} are locally $\CAT{\kappa}$ have been completely answered by the first author, David Berg, and Richard Bishop \cite{alexander-berg-bishop1993}.
...
Note that any metric tree (see Section~\ref{sec:Ultralimit of spaces}) is $\CAT{-\infty}$;
