...
A quadruple $p^1,p^2,x^1,x^2\in \spc{X}$ satisfies $\CAT\kappa$ comparison if one of the following holds:
\begin{subthm}{}
One of the triples 
$(p^1,p^2,x^1)$ 
or 
...
\begin{subthm}{}
$\spc{U}$ is $\CAT{\kappa}$ 
if any quadruple $p,x^1,x^2,x^3\in \spc{U}$ satisfies  $\Alex\kappa$ comparison.
\end{subthm}

\begin{subthm}{}
$\spc{U}$ is \index{locally $\CAT{\kappa}$}\emph{locally $\CAT{\kappa}$} 
if any point $q\in \spc{U}$ admits a neighborhood $\Omega\ni q$ such that any quadruple $p,x^1,x^2,x^3\in \Omega$ satisfies  $\CAT\kappa$ comparison.
\end{subthm}

\begin{subthm}{}
$\spc{U}$  is a  $\CAT{}$ space if  $\spc{U}$  is $\CAT{\kappa}$ for some $\kappa\in\RR$.
\end{subthm}
\end{thm}
...
\begin{thm}{Reshetnyak gluing theorem}\label
{thm:gluing}
Suppose 
