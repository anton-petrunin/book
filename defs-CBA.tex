...
The proof uses a thin-triangle decompositions, 
...
\parit{Proof.} 
By the angle-sidelength  monotonicity  (\ref{cor:monoton-cba}), the right-hand side is defined and bigger than or  equal to the lefthand side. 
...
the right-hand side is less than or equal to the lefthand side.
\qeds
...
Let $D_i$ be subgraph of $\beta_i$ with respect to $p$.
