...
Let us list some important sources of examples of $\CAT{}$ spaces.
...
The subsets of \textit{positive reach} in Riemannian manifold were studied in this context by 
...
as usual, we assume that it is equipped with induced length metric.
...
In higher dimensions things are more complicated, even for Euclidean ambient space;
see \cite[Chapter 4]{alexander-kapovitch-petrunin-CAT} for related questions (open and solved).

By Gauss formula, smooth saddle surfaces in manifolds with sectional curvature at most $\kappa$ are locally $\CAT\kappa$.
...
Among more conceptual examples, let us mention the result of Brian Clarke \cite{clarke}: the \textit{space of Riemannian metrics} of a compact, orientable smooth manifold
with respect to the $L^2$-distance is $\CAT0$;
a shorter proof of this statement was given by Nicola Cavallucci \cite{cavallucci}.
Also, by to the result of Tam\'{a}s Darvas \cite{darvas}, the \textit{space of K\"{a}hler potentials} on a compact K\"{a}hler manifold is $\CAT0$.
