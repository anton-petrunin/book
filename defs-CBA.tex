...
Let us list the most important sources of examples of $\CAT{}$ spaces.
...
The \textit{Hilbert space} is another motivating example of $\CAT{0}$ spaces.
...
Further, any open simply-connected \textit{subset of the plane} equipped with induced length metric is $\CAT{0}$. 
