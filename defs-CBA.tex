...
The necesury techniques to prove these theorems include 
...
From Uniqueness of geodesics~\ref{thm:cat-unique}
...
A detailed proof of Gromov's statement when $\spc{U}$ is proper  was given by Werner Ballmann \cite{ballmann:cartan-hadamard};
it use Birkhoff's curve-shortening.  
The statement in the non-proper  case was proved in the first author and Richard Bishop \cite{a-b:h-c}.  
...
The generalized Hadamard--Cartan theorem for proper spaces was proved by Brian Bowditch \cite{bowditch}.
...
However, as it follows from Proposition~\ref{prop:sc}, for locally $\CAT\kappa$ spaces, these two definitions are equivalent.
The latter makes possible to deduce Hadamard--Cartan theorem directly from the Generalized Hadamard--Cartan theorem.
