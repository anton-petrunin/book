...
it was first mentioned Michael Gromov \cite[6.B$_1\mathrm{(f)}$]{gromov:asymt-inv}.
...
It is expected that \ref{lem:patch} can be extended to all curves, not necessarily local geodesics,
