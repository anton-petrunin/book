...
A typical rectifiable closed curve in a $\CAT0$ space can be majorized by many convex figures.
Richard Bishop asked if it is allways the case with the following two exceptions: (1) if the majorization map is distance preserving and (2) if the curve is  formed by three sides of a geodesic triangle.
