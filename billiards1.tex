\section{Semi-dispersing billiards}
...
%with \emph{regular reflection} 
%(??? this terminology is not used, but ``standard law of billiards'' is used) 
which follows  the
...
\parit{Proof.} Apply Reshetnyak's gluing theorem \ref{thm:gluing} recursively for the the convex sets in the array.
\qeds
...
\lbl[b]{21,47,6;$\alpha$}
\lbl[b]{31,3,6;$\alpha$}
\lbl[b]{13,13,-71;$\pi-\alpha$}
\lbl[t]{42,23,-71;$\pi-\alpha$}
\end{lpic}
\end{wrapfigure}
