...
it was given in a lonely publication on a ``coordinateless description of Gauss surfaces'' published in 1936.
...
It includes his \emph{majorization theorem} and \emph{gluing theorem}.
...
\begin{itemize}
\item The book of Martin Bridson and André Haefliger \cite{BH} gives the most comprehensive introduction available today. 
...
The so called \emph{curvature dimension condition} introduced by John Lott, Cédric Villani and Karl-Theodor Sturm gives a synthetic description of Ricci curvature bounded below; see the book of Villani \cite{villani} and references therein.
