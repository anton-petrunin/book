...
\item The book \cite{alexander-kapovitch-petrunin-CAT} by the three authors of the present volume  gives an introduction aiming at reaching interesting applications and theorems with a minimum of preparation.
\item The book of Jürgen Jost \cite{jost:book} gives a more analytic viewpoint to the subject.
\item The book of Athanase Papadopoulos \cite{papadopoulos} gives a comprehensive introduction to nonpositive curvature in the sense of Busemann.
...
This is a well-developed subject with a large number of subfields and applications, such as the theory of small cancellation groups, automatic groups,  mapping class groups, automorphisms of free groups, isoperimetric inequalities on groups, actions on $\R$-trees, and Gromov's boundaries of groups.
