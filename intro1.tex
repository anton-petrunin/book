...
Another volume still in preparation will cover further topics specific to finite dimensional Alexandrov spaces.
...
%
Let us give a list of available introductory texts on Alexandrov spaces with curvature bounded below: %V: the phrase "available introductions" sounds very awkward so I replaced it here and below.
\begin{itemize}
...
During the long writing of this book, we were partially supposrted by the following grants:
Stephanie Alexander --- 
