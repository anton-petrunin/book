...
Let us note however that our presentation is not always linear and  sometimes some technical proofs and topics are deferred for later chapters to streamline the exposition and make it more natural.


%The prime purpose of the book is to provide a  comprehensive reference source.%%% V: this was redundant to the previous paragraph so I commented it out.

The first volume includes material up do the definition of dimension.
The second volume covers finite dimensional spaces.
However we do not follow the rule all the time, trying to keep similar materials closer.
