...
that is, you want to show that $\mathbb{S}^2\times \mathbb{S}^2$ does not carre a metric with positive sectional curvature. 
Assume it is wrong, then there is a 4-dimensional complete length $\Alex0$ space $\spc{L}$ which is homeomorphic to $\mathbb{S}^2\times \mathbb{S}^2$ and volume-maximizing.
