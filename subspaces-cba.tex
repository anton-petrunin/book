...
We use the Arm Lemma \ref{lem:arm} to give a curvature globalization theorem for curves, of the type proved by Schur and Schwartz for curves of bounded geodesic curvature in the plane \cite{chern}.  This material is from \cite{ab:cbc}.
...
%\end{thm}
%
\parit{Proof of Theorem \ref{thm:global-arc-chord}. %and Lemma \ref{prop:base-angle}.
} 
