...
curvature $k$, where $\II$ is a closed, possibly infinite, interval.  A {\it complete} $k$-curve is a $k$-curve that is maximally extended so as to self-intersect at most at its endpoints: that is, a circle traversed once, or a  geodesic, horocycle, or equidistant curve.
