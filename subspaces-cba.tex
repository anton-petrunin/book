...
subarcs $ \bar\gamma=\gamma|(t_0-\epsilon,t_0+\epsilon)$ as $\epsilon\to 0$. (If $t_0$ is the left or right endpoint of $\gamma$, use $[t_0,t_0+\epsilon)$ or $  (t_0-\epsilon,t_0]$ accordingly.) 
...
The next corollary  spells out the significance of, and follows directly from, Theorem \ref{thm:global-arc-chord}:
