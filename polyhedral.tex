...
Assume that a spherical polyhedral space $\spc{P}$
admits a triangulation $\tau$ such that all edges of all simplices in $\tau$ are at least $\tfrac\pi2$.
...
Analogs of the flag condition for spherical Coxeter simplices
