...
by the above is $\CAT0$ and hence is contractible.
...
to construct a closed smooth 4-dimensional manifold $M$ with universal cover $\tilde M$ diffeomorphic to $\RR^4$ such that (1) $M$ admits a polyhedral metric which is locally $\CAT0$ but it does not admit a Riemannian metric with nonpositive sectional curvature.
