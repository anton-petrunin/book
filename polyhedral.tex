...
A length space $\spc{P}$ is called \index{piecewise
...
determines the isometry class of $\Sigma_p$ and the other way around.
...
The above question has an affirmative answer for $n\le 3$ and open for all $n\ge 4$ \cite{charney-davis-1993,panov-petrunin}.
